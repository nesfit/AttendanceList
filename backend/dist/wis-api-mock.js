...
app.use(_express2.default.json()); // parser for application/json request type

app.get('/FIT/db', function (req, res) {
...
app.get('/FIT/db/vyuka/rest/courses', function (req, res) {
...
app.get('/FIT/db/vyuka/rest/course/:course', function (req, res) {
...
app.get('/FIT/db/vyuka/rest/course/:course/items', function (req, res) {
  if (req.params.course !== '12876') {
    res.json({});
    return;
  }
  ...
  var json = {
    ...
    'data': [{
      ...
      'order': 2,
      'max': 15,
      'title': 'P\u016Flsemestr\xE1ln\xED zkou\u0161ka',
      'start': '2019-03-22',
      'end': '2019-03-22',
      ...
      'min': 25,
      'max': 60,
      'title': 'Semestr\xE1ln\xED zkou\u0161ka',
...
app.get('/FIT/db/vyuka/rest/course/:course/item/:item/variants', function (req, res) {
...
app.get('/FIT/db/vyuka/rest/course/:course/item/:variant', function (req, res) {
...
app.get('/FIT/db/vyuka/rest/course/:course/item/:variant/students', function (req, res) {
  if (req.params.course !== '12876' || req.params.variant !== '73044') {
    res.json({});
    return;
  }
...
app.get('/FIT/dns/getid', function (req, res) {
  var id = req.query.hex;
...
_https2.default.createServer(_config2.default.https, app).listen(2001);